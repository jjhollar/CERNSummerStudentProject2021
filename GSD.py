...
options.setDefault('outputFile', 'file:gammagammamumu_FPMC_pT25__PU140_GSD_2_version3.root')
options.setDefault('maxEvents', 100)
options.register("pileup", 140, VarParsing.multiplicity.singleton, VarParsing.varType.int,
    "pileup")
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/jjhollar/PPS-FPMCMuMuElastic25_LHE.root'),
#                            fileNames = cms.untracked.vstring('file:PPS-LPairMuMuElastic25_LHE.root'),
...
if options.pileup > 0:
    ...
    process.mix.input.fileNames = cms.untracked.vstring(["file:/tmp/jjhollar/F7FE3FE9-565B-544A-855E-902BA4E3C5FD.root"])

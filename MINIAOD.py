...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:gammagammamumu_FPMC_pT25_RECO_2.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:gammagammamumu_FPMC_pT25_MINIAOD_2_version3.root'),
...
process.MINIAODSIMoutput.outputCommands.append('keep SimVertexs_g4SimHits_*_*')
